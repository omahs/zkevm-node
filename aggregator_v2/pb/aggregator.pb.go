...
type RegisterRequest struct {
	...
	ProverId string `protobuf:"bytes,1,opt,name=prover_id,json=proverId,proto3" json:"prover_id,omitempty"`
}
...
func (x *RegisterRequest) GetProverId() string {
	if x != nil {
		return x.ProverId
	}
	return ""
...
func (x *RegisterResponse) GetAggregatorId() string {
	if x != nil {
...
var file_aggregator_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x6f, 0x72, 0x5f, 0x76, 0x32, 0x2f, 0x70, 0x62,
...
var file_aggregator_proto_goTypes = []interface{}{
	(*Version)(nil),          // 0: aggregator.v1.Version
	(*RegisterRequest)(nil),  // 1: aggregator.v1.RegisterRequest
	(*RegisterResponse)(nil), // 2: aggregator.v1.RegisterResponse
}
var file_aggregator_proto_depIdxs = []int32{
	1, // 0: aggregator.v1.Aggregator.Register:input_type -> aggregator.v1.RegisterRequest
	2, // 1: aggregator.v1.Aggregator.Register:output_type -> aggregator.v1.RegisterResponse
